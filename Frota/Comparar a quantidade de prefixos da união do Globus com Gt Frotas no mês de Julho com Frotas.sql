-- Comparar a quantidade de prefixos da união do Globus com Gt Frotas no mês de Julho que não estão em Frotas
...
WHERE PREFIXO NOT IN ( SELECT PREFIXOVEIC FROM fact_vwpbi_frota WHERE CONDICAO = 'Ativo');