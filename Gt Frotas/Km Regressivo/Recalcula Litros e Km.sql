...
ROUND((HAS_ENCERRANTE_DEPOIS - HAS_ENCERRANTE_ANTES),1) 
AS RecalculaLitros, HAS_QTD_LITROS,
CASE
WHEN ABS((HAS_ENCERRANTE_DEPOIS - HAS_ENCERRANTE_ANTES) - HAS_QTD_LITROS) <= 0.05   THEN "" ELSE "ERRO"
...
KM_ANT, HAS_ODOMETRO,  HAS_ENCERRANTE_ANTES, HAS_ENCERRANTE_DEPOIS, TER_DATA_ULTIMA_COMUNIC
