...
vai listar os prefixos que abasteceram acima de 0.01 sem deslocamento */
...
FROM fact_vwpbi_abastecimento_detalhado WHERE DATA >= '2025-01-01 00:00:00' AND ROUND(HODFINALVELOC - HODINICIALVELOC , 3) = 0  AND LITROS >= 0.01
ORDER BY DATA ASC